    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Dev Section --> */}
          {permissions.includes('MANAGE_COMPONENTS') && (
            <div>
              <div>
          ...
          {permissions.includes('MANAGE_PERSONAL') && (
            <div>
              <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
                ADMIN. PERSONAL
              </h3>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/appointments' || pathname.includes('appointments')
                }
              >
                {(handleClick, open) => {
                  return (
          ...
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
              ADMIN. HISTORIAS CLÍNICAS
            </h3>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/health_records' || pathname.includes('health_records')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes('health_records') &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
